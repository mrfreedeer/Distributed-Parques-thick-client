...
if player.colour == "red" then
    homecolour = homeredpos
elseif player.colour == "blue"
    homecolour = homebluepos
elseif player.colour == "yellow"
    homecolour = homeyellowpos
else
    homecolour = homegreenpos
end
